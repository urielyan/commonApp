...
void testClone()
{
    ...
    QString json = readFile("F:/svnCode/deleted/qt-json-master/example/complex.json");
    if (json.isEmpty())
...
int main(int argc, char **argv) {
    QString json = readFile("F:/svnCode/deleted/qt-json-master/example/example.json");
    if (json.isEmpty()) {
        qFatal("Could not read JSON file!");
        return 1;
    }
